...
export function PaginationPrevious({ href = null, className, children = 'Previous', onClick, disabled }) {
...
export function PaginationNext({ href = null, className, children = 'Next', onClick, disabled }) {
  return (
...
export function PaginationPage({ href, className, current = false, children, onClick }) {
  return (
    <Button
      onClick={onClick}
      plain
